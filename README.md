...
* Stacking isn't natively supported by Subtitle Engine. (havent tested how stacking works, but these are probably the outcomes) While duplicate subtitles will still group together, there's no indicator for many are stacked.
